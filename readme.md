...
Una vez ejecutado el servidor, en la ruta "./src/models/server.js" linea 62, se debe cambiar el valor true del "sequelize.sync" a false para que  no siga forzando la creacion de la tabla MySQL, borrando todo lo que este guardado en la base de datos al recrearla.
